...
def get_test_data(input_data_path):
    ...
    with open(input_data_path) as f:
        ...
        data_file_label = [int(s.split(' ')[1])-1 for s in data_file_list]
...
def main():  
    # Dataset path
    test_thermal_list = 'data_file_thermal.txt'
    test_color_list = 'data_file_color.txt'
    dataset_path = ''
    model_path = 'log/tone_iter2_0.ckpt'
    save_dir = ''
    ...
    with tf.Session() as sess:
        ...
        feature1, feature2 = tf.split(feature, 2, 0)
