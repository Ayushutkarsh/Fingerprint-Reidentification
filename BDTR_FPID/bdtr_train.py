...
def main():
    ...
    feature1, feature2 = tf.split(feat, num_or_size_splits=2,axis=0)
    # pdb.set_trace()
    print("################ feat1 shape",feature1.shape)
    ...
    test_thermal_list = '/Users/ayush/projects/Visible-Thermal-Person-Re-Identification-master/BDTR/data_file_thermal.txt'
    test_color_list = '/Users/ayush/projects/Visible-Thermal-Person-Re-Identification-master/BDTR/data_file_color.txt'
